...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default="yolo_v2.pt" , help='Model weights to use for inference')
    ...
    parser.add_argument('--save_images', type=bool, default=False, help='Flag to save images with boxes and classes to local')
    parser.add_argument('--check', type=bool, default=True, help='Flag to check with current model in production saved on cloud')
