...
def parse_opt(known=False):
    ...
    parser.add_argument('--remote', type=bool, default=False, help='Flag for downloading YOLO model from local or remote (Azure Blob Storage)')
...
def main(opt):
    ...
    consumer.consume_camera(opt.result_server, opt.result_topic, opt.remote, opt.save_images)
