...
class Consumer():
    ...
    def consume_camera(self):   
        ...
        yolo_model = torch.hub.load('model/yolo/ultralytics_yolov5_master', 'custom', path='C:/Users/guill/Desktop/INDIZEN/Capstone/YOLOV5/yolov5-master-ultralytics/runs/train/exp18/weights/last.pt', source = "local",force_reload=True)
